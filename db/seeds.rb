...
# request.body = 'fields name,platforms,player_perspectives,rating,rating_count,total_rating,release_dates,screenshots,storyline; search "' + search + '"; limit 100;'
...
url = "localhost:3030/https://api.igdb.com/v4/games"
